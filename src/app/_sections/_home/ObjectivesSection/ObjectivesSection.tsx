        ...
        <div className={styles.objective}>
          ...
          <div className={styles.objective_paragraph_and_img}>
            <p className={styles.objective_paragraph}>
              ...
              être un frein au développement des entreprises à l’échelle
              mondiale. Nous nous engageons donc à fluidifier les échanges
              commerciaux internationaux en proposant des solutions efficaces et
              accessibles.
            </p>
            <img className={styles.objective_img} src="/medias/goal.png" />
          </div>
        </div>
        <div className={styles.objective}>
          ...
          <div className={styles.objective_paragraph_and_img}>
            <img className={styles.objective_img} src="/medias/shield.png" />
