...
export default function PrivacyPolicyPage() {
  return (
    <div className="politics">
      <h2 className="politics_title">Politique de confidentialité</h2>
      <p>
        <span>
          YVEA (« YVEA », « notre », « nous » et « nos ») et nos partenaires
          respectent votre vie privée.
        </span>
        <br />
        <br />
        Nous vous demandons de bien vouloir lire attentivement la présente
        politique de confidentialité pour comprendre comment vos données
        personnelles sont collectées, traitées et conservées lors de votre
        utilisation du site internet YVEA, accessible via l'URL https://yvea.io.
        <br />
        <br />
        L'ensemble des données personnelles collectées sur le présent site
        internet sont traitées sous la responsabilité de la société YVEA, SASU
        au capital social de 1000 €, immatriculée au Registre du Commerce et des
        Sociétés de Paris sous le numéro 914285259, et ayant son siège social 27
        Rue du Chemin Vert, 75011 PARIS, France.
        <br />
        <br />
        Au sens de la réglementation applicable aux données personnelles, YVEA
        est donc responsable de traitement.
        <br />
        <br />
        Cette politique de confidentialité décrit :
        <br />
        <br />
        1. Comment YVEA utilise vos données personnelles
        <br />
        2. Comment YVEA partage vos données personnelles
        <br />
        3. Comment YVEA protège vos données personnelles
        <br />
        4. Où YVEA héberge et transfère vos données personnelles
        <br />
      ...
      <br />
      <br />
      <div className="politics_article">
        ...
        <p>
          ...
          <ul className="politics_list">
            <li>
              Publier et gérer vos avis et/ou commentaires laissés sur le site
              internet
            </li>
            <li>
            ...
            <li>
              Répondre à votre demande de contact effectuée à partir de notre
              site internet
            </li>
          </ul>
          <br />
          <br />
          Le traitement de vos données personnelles est réalisé dans une
          démarche de prise de contacte précontractuelle, ce traitement est basé
          sur votre consentement à être contacté afin d'échanger sur nos offres
          et obtenir un devis. Vous pouvez retirer ce consentement à tout moment
          et demandé à ce que nous supprimions vos informations et cessions de
          vous contacter.
          <br />
          <br />
          ...
          cela ne vous empêchera pas de créer votre compte client et de passer
          des commandes sur notre site internet.
        </p>
      </div>
      <div className="politics_article">
        <h3 className="article_title">
        ...
        <p>
          Au sein de YVEA, et au regard de chaque finalité de traitement, les
          données personnelles vous concernant sont collectées, traitées et
          stockées par le personnel habilité de YVEA, uniquement dans le cadre
          de leurs compétences respectives, et notamment par le service client,
          le département marketing et le département informatique.
          <br />
          ...
          <br />
          <br />
          <span>(1) Le partage avec consentement préalable : </span>après avoir
          obtenu votre consentement, YVEA partagera les informations que vous
          ...
          <br />
          <span>(2) Le partage avec nos prestataires :</span> YVEA peut
          également divulguer vos informations à des entreprises qui fournissent
          des services pour nous ou en notre nom. Ces prestataires de services
          ...
          peuvent utiliser vos informations uniquement dans le but de vous
          fournir des services au nom de YVEA.
          <br />
          <span>
            (3) En exécution d'une obligation légale, le partage conformément
            aux lois et à la réglementation :
          </span>{" "}
          YVEA, peut partager vos informations comme le stipulent les lois et la
          réglementation, afin de résoudre les différends d'ordre juridique, ou
          comme le stipulent les autorités judiciaires ou administratives en
          vertu de la loi.
          <br />
          <br />
          YVEA s'assurera de la légalité de tout partage des données
      ...
      <div className="politics_article">
        <h3 className="article_title">
          3. Où YVEA héberge et transfère vos données personnelles
        </h3>
        <p>
          Vos données personnelles seront hébergées au sein des infrastructures
          d'hébergement de notre hébergeur, HOSTINGER, situé en Chypre.
          <br />
          <br />
      ...
      <div className="politics_article">
        ...
        <p>
          ...
          applicable.
          <br />
          <br />- Le <span>droit d'accès</span> signifie que vous pouvez nous
          demander à tout moment de vous indiquer si nous traitons des données
          personnelles vous concernant et, le cas échéant, de vous indiquer
          quelles sont les données personnelles concernées ainsi que les
          caractéristiques du ou des traitements effectués.
          <br />
          <br />- Le <span>droit de rectification</span> signifie que vous
          pouvez nous demander la rectification de vos données personnelles
          lorsqu'elles sont inexactes. Vous pouvez également demander à ce que
          vos données personnelles, dès lors qu'incomplètes, soient complétées
          dans la mesure où cela est pertinent au regard de la finalité du
          traitement en cause.
          <br />
          <br />- Le <span>droit à l'effacement</span> signifie que vous pouvez
          demander d'effacer vos données personnelles notamment lorsque : Leur
          conservation n'est plus nécessaire au regard des finalités pour
          lesquelles elles ont été collectées;
          <br />
          Vos données personnelles sont traitées sur le fondement de votre
          consentement, vous souhaitez retirer ce consentement, et il n'existe
          pas d'autre fondement juridique susceptible de justifier le traitement
          ; Vous vous êtes opposé au traitement de vos données personnelles et
          vous souhaitez en conséquence qu'elles soient effacées ; Vos données
          personnelles ont fait l'objet d'un traitement illicite ;
          <br />
          Vos données personnelles doivent être effacées pour respecter une
          obligation légale qui est prévue soit par le droit de l'Union
          Européenne soit par le droit français.
          <br />
          <br />- Le <span>droit à la limitation</span> signifie que vous pouvez
          nous demander de procéder à la limitation du traitement de vos données
          personnelles : Lorsque vous contestez l'exactitude de vos données
          personnelles pendant une durée nous permettant de vérifier
          l'exactitude de celles-ci ; Lorsque suite à un traitement établi comme
          non conforme, vous préférez la limitation du traitement à l'effacement
          complet de vos données personnelles ;
          <br />
          Lorsque nous n'avons plus besoin de vos données personnelles aux fins
          ...
          durée nous permettant de vérifier si le motif légitime que vous
          invoquez se justifie.
          <br />
          <br />
          ...
          <br />
          <br />- Le <span>droit d'opposition</span> signifie que vous pouvez
          vous opposer au traitement de vos données personnelles, lorsque ce
          traitement est fondé sur la poursuite de l'intérêt légitime de YVEA.
          ...
          <br />
          <br />- Le <span>droit à la portabilité</span> signifie que vous
          pouvez nous demander, dans les conditions posées par la réglementation
      ...
      <div className="politics_article">
        <h3 className="article_title">
          5. Les mises à jour de cette politique de confidentialité
        </h3>
        <p>
          YVEA se réserve le droit à tout moment de modifier ou mettre à jour,
          en tout ou en partie, la présente politique de confidentialité, en
          raison de la modification de la réglementation applicable en matière
          de protection des données personnelles ou des traitements de données
          effectués.
          <br />
          <br />
      ...
      <div className="politics_article">
        <h3 className="article_title">6. Nous contacter</h3>
        <p>
          ...
          soumettant à <span>contact@yvea.io</span>.
          <br />
          Ou par courrier postal à 27 RUE DU CHEMIN VERT, 75011 PARIS, France.
          <br />
          Si vous n'êtes pas satisfait de la réponse apportée par YVEA à une
          demande d'exercice de droits conformément à l'article 5 ci-dessus ou
          que vous souhaitez signaler une atteinte à la réglementation
          ...
          son site Internet (www.cnil.fr), ou auprès de l'autorité de protection
          des données du pays dans lequel vous résidez ou travaillez
          habituellement.
        </p>
      </div>
    </div>
