      ...
      <div className={styles.main_container}>
        <div className={styles.header_section}>
          <h1 className={styles.title}>
            {t("YVEA Free : Découvrez l'efficacité, même en mode freemium.")}
          </h1>
        ...
        <ul className={styles.list}>
          ...
          <li className={styles.list_item}>
            <p className={styles.list_description}>
              <span className={styles.item_bold}>{t("Accompagnement")}</span>
              {t(
        ...
        <h2 className={styles.second_title}>{t("Qualité, sans se ruiner.")}</h2>
        <p className={styles.paragraph}>
          {t(
            "Nous mettons un point d'honneur à offrir le meilleur, quel que soit votre budget. Pour seulement 39,95€ HT par dossier, bénéficiez d'une expertise inégalée."
          )}
        </p>
        ...
        <p className={styles.paragraph}>
          ...
          <Link className={styles.link} href="/pricing/offers/pro">
            {t(" offre Pro")}
          </Link>
          {t(
